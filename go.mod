module github.com/siuyin/adkgo2
...
require (
	...
	github.com/craigh33/adk-go-ollama v1.0.11 // indirect
	...
	github.com/siuyin/adk-go-ollama v0.0.2-0.20260805051920-6ebae642cfe6 // indirect
